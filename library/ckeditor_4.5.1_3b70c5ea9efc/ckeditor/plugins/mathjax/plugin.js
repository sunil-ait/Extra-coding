...
( function() {
	CKEDITOR.plugins.add( 'mathjax', {
		...
		init: function( editor ) {
			editor.config.mathJaxLib = '//cdn.mathjax.org/mathjax/2.2-latest/MathJax.js?config=TeX-AMS_HTML';
			var cls = editor.config.mathJaxClass || 'my-tex',
				docsUrl = '//cdn.mathjax.org/mathjax/2.2-latest/MathJax.js?config=TeX-AMS_HTML';
